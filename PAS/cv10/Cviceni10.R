...
## Na 5% hladine vyznamnosti rozhodnete, zda stredni hodnota porodni hmotnosti deti muze byt 3.5kg.
  ...
  MeanCI(porHmotnost, conf.level = 0.95)
...
MeanDiffCI(hmotnost ~ koj24)
t.test(hmotnost ~ koj24)
...
BinomCI(table(koj24)[1], sum(table(koj24)), method = "wald", conf.level = 0.9)
